...
This repo is mostly based off this [repo](https://github.com/valnoxy/t440p-oc). The only difference is that this repo has updated kext files for OpenCore 0.9.3 and Ventura.
